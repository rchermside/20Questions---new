...
//Command Line Guesser
public class CLGuesser extends NewGuesser{

    public CLGuesser(String startingInstruction, ArrayList<Guess> guesses, String question){
        super(startingInstruction, guesses, question);
    }
...
//    boolean guessed = false;
//    ArrayList<NewNewResponse> responseHistory = new ArrayList<NewNewResponse>();
...
//      if (!(question.yesGuesses.containsAll(clone) || question.noGuesses.containsAll(clone))){
//        //ask the question
//        NewResponse response = askNewQuestion (in, question, myGuesses);
//        //System.out.println ("My guesses are: " + myGuesses);
//        if (response.answer.equals("quit")){
//          return;
//        }
