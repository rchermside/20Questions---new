...
public class NewQuestion{
    ...
    public HashMap<Short, Integer> numYeses;  //for each guess how many times a user has entered yes for this question
    public HashMap<Short, Integer> numNos;  //for each guess how many times a user has entered no for this question
    public HashMap<Short, Integer> numResponses;  //total number of times a user has entered a response to this question either yes, no, or unclear

    boolean v;  //has question been verified
    ...
    NewQuestion (String question, HashSet<Short> yesGuesses, HashSet<Short> noGuesses, HashSet<Short> maybeGuesses){
        this(question);
  ...
  public void verify(){
    ...
    public boolean equals(NewQuestion q){
